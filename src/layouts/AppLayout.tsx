    ...
    <div className="flex h-screen w-screen overflow-hidden bg-background text-foreground font-sans">
      ...
      >
          ...
          {navItems.map((item) => {
            ...
            return (
              <NavLink
                key={item.to}
                to={item.to}
                className={`flex items-center justify-between px-3 py-2.5 rounded-2xl text-xs sm:text-sm font-medium transition group ${
                  isActive
        ...
        <div className="p-3 border-t border-border/50 space-y-1">
          <NavLink
            to="/settings"
            className={`flex items-center space-x-3 px-3 py-2.5 rounded-2xl text-xs sm:text-sm font-medium transition ${
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-card/90 backdrop-blur-xl border-t border-border flex items-center justify-around px-2 z-40">
        <NavLink
          to="/"
          className={({ isActive }) =>
        ...
        <button
          ...
          className="flex items-center justify-center w-12 h-12 rounded-2xl bg-primary text-primary-foreground shadow-lg shadow-primary/25 active:scale-95 transition -mt-5"
          title="Tạo mới"
        >
